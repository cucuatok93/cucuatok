...
wget -O /usr/bin/disable-user-expire "https://raw.githubusercontent.com/cucuatok93/cucuatok/master/cucuatok93/cucuatok/master/tools/disable-user-expire.sh"
